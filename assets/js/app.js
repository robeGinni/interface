...
let addr;
const sttaddr = "0x90128b024a46e845c3a4b4f62617cdd9d64fe20e";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x90128b024a46e845c3a4b4f62617cdd9d64fe20e";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ethereumblue.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x90128b024a46e845c3a4b4f62617cdd9d64fe20e',
                    'symbol': 'ETHBLUE',
                    'decimals': '9',
                    'image': 'https://ethereumblue.net/assets/images/logo.png',
                },
            },
